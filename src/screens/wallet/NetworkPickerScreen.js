  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Choose which network to use for {symbol}.</Text>
      </View>
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable
            style={styles.row}
            onPress={() => navigation.navigate(targetRoute, { chainId: item.id, symbol })}
          >
            <TokenIcon symbol={symbol} chainId={item.id} size={38} />
